...
func ParseAndBuildArg() Args {
	...
	pflag.IntVarP(&params.TotalDataSize, "TotalDataSize", "", 16000, "the total number of txs")
	pflag.IntVarP(&params.BatchSize, "BatchSize", "", 16000, "supervisor read a batch of txs then send them, it should be larger than inject speed")
